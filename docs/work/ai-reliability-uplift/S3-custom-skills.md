...
2. Read the most recent 3 archived initiative docs in `docs/archive/work/` to
   calibrate tone
  and detail level.
...
5. Write the draft to the correct location:
   - One-off: `docs/work/YYYY-MM-DD-<slug>.md`
   - Multi-stage: `docs/work/<feature-slug>/README.md` plus staged files like
     `S1-<name>.md`, `S2-<name>.md`, and a folder-local `work-status.json`
...
### U6: Update root AGENTS.md and docs guidance

Add a "Skills" section to root guidance that lists available skills and notes
that agents should prefer invoking a skill over improvising the same procedure.
Point to `.agents/skills/` for the full list.
