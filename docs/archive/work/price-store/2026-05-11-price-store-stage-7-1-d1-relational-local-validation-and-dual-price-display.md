...
Stage 7.1 inherits its scope from the current staged rewrite of the Stage 7
plan in
[docs/work/price-store/S2-cloudflare-scheduled-capture-and-internal-publish.md](/C:/Users/ptier/repos/Deck Archive Project/docs/work/price-store/S2-cloudflare-scheduled-capture-and-internal-publish.md),
