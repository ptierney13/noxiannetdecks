/**
 * WIP: Card Search Guide — real card image with invisible hotspot overlays.
 *
 * Hotspot positions were calibrated with a Playwright 2%-grid ruler overlay
 * (scripts/ruler-check.cjs). Positions are percentages of the 744×1039 card image.
 *
 * NOT currently rendered. Keeping for future polish once hover UX on the real
 * image is validated. To re-activate, swap the import in App.tsx.
 */
...
export function CardSearchGuideImageOverlay() {
