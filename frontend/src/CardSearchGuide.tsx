...
const ZONES: Record<ZoneId, ZoneInfo> = {
  ...
  "tag-mech":      { label: "Tag",          query: "tag:mech",                                                           description: "Matches a specific type tag. Tags include tribes and origins." },
  "tag-blitzcrank":{ label: "Tag",          query: "tag:blitzcrank",                                                     description: "Matches a specific type tag. Tags include tribes and origins." },
  "tag-zaun":      { label: "Tag",          query: "tag:zaun",                                                           description: "Matches a specific type tag. Tags include tribes and origins." },
