    ...
    >
      {headerShellMode === "desktop" ? (
        ...
        >
          <button
            type="button"
            className={`inline-flex items-center gap-[0.8rem] border-0 p-0 bg-transparent text-text-primary cursor-pointer overflow-hidden min-w-0 ml-[calc(0.6rem_-_var(--space-shell-x))] transition-[max-width,opacity,transform] duration-[220ms,180ms,220ms] ease-[cubic-bezier(0.22,1,0.36,1),ease,ease] ${isCompact ? "max-w-[2.2rem]" : "max-w-[18rem]"}`}
